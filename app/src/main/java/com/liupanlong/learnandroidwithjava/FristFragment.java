...
public class FristFragment extends Fragment {
    ...
    public FristFragment(String name) {
        this.name = name;
    }
    ...
    public static FristFragment newInstance(String name, String param1, String param2) {
        FristFragment fragment = new FristFragment(name);
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, param1);
        args.putString(ARG_PARAM2, param2);
        fragment.setArguments(args);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        infoShow = view.findViewById(R.id.fragmentFirstInfoShow);
